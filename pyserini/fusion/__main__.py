...
import argparse
from pyserini.fusion import reciprocal_rank_fusion, interoplation
from pyserini.trectools import TrecRun, FusionMethod
...
if len(args.runs) < 2:
    raise Exception("Fusion must be performed on at least two runs.")
...
if args.method == FusionMethod.RRF:
    ...
    fused_run = interoplation(trec_runs, alpha=args.alpha, depth=args.depth, k=args.k)
